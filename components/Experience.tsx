...
export const experiences = [
  ...
  },
  {
    ...
    logo: "/images/Experience/css.jpg",
  },
];
...
const Experience = () => {
  ...
  return (
    <div className="bg-[#141619] text-[#31a9d8] py-8" id="experience" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {experiences.map((experience, index) => (
            <motion.div
              key={index}
              className="shadow-lg bg-[#141619] text-[#31a9d8] border border-[#31a9d8] rounded-lg overflow-hidden mt-4 flex"
