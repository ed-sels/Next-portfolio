...
const links = [
  ...
  {
    href: "https://github.com/ed-sels",
    label: "GitHub",
    icon: <FaGithub size={24} />,
  },
  {
    href: "mailto:edwinselorm10@gmail.com",
    label: "Email",
    icon: <FaEnvelope size={24} />,
  },
  {
    href: "https://www.linkedin.com/in/edwin-selorm-mottey-779158271/",
    label: "LinkedIn",
...
const Hero = () => {
  ...
  return (
    <motion.section
      id="hero"
      className="relative w-full max-w-screen flex flex-col lg:flex-row items-center justify-center lg:h-screen p-6 mb-20 bg-[#141619]"
      ref={ref}
      initial="hidden"
      animate={controls}
    >
